...
class CharacterCarousel extends StatefulWidget {
  ...
  CharacterCarousel({required this.personajes});
...
class _CharacterCarouselState extends State<CharacterCarousel> {
  ...
  void initState() {
    ...
    _pageController = PageController(
      ...
      // by default our character thumbnail
    ...
    return Padding(
      ...
      child: AspectRatio(
        ...
        child: PageView.builder(
          ...
          itemBuilder: (context, index) => buildCharacterSlider(index),
        ),
      ),
    );
  }

  Widget buildCharacterSlider(int index) => AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return AnimatedOpacity(
            ...
            child: Transform.rotate(
              angle: math.pi * value,
              child: PersonajeCard(personaje: widget.personajes[index]),
            ),
          );
        },
      );
